...
describe Enumerable do
  ...
  describe '#my_each_with_index' do
    let(:new_arr) { [2, 6, 8] }
    it 'Iterate over the array, do the instructions in the block over each element and returns the elements changed based in the instructions of the block predicate' do
      expect do
  ...
  describe '#my_inject' do
    ...
    it 'Iterate over the array is called and return the value of the operation perfomed based the first argument (a symbol)' do
      expect(new_range.my_inject(:+)).to eq(45)
    end

    it 'Iterate over the array is called and return the value of the operation performed when two arguments are passed' do
